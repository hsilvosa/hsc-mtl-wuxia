...
def align_segments(segments_ch, segments_en):
    """
    Aligns segments and returns text + scores of similarity.
    """
...
def calculate_and_print_metrics(global_stats, total_elapsed):
    """
    Calculates metrics derived and the prints, including combinations dynamic K:1 and 1:L.
    """
...
def process_all_files(input_dir="."):
    """
    Processes files, aligns and saves text and similitudes in two files separate.
    """
...
if __name__ == '__main__':
    ...
    skip_penalty = -0.2  # penalty by skip segments
